...
# from model import convnext_tiny as model1
from ronghe import getModel as model1
...
def main(args):
    ...
    # model = model1(num_classes=args.num_classes).to(device)
    ...
    with torch.no_grad():
        for val_data in tqdm(val_loader, file=sys.stdout):
            ...
            outputs1 = model(val_images.to(device))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-path', type=str,
                        default="/home/user/PycharmProjects/hl/mydml/SARS-Cov-2/sars/")

    # 训练权重路径
    parser.add_argument('--weights', type=str, default='./rongheweights/',
